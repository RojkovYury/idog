...
export default function ServicesContent({ currentContent }: ServicesContentProps) {
  ...
  return(
    ...
    >
      ...
      <Box sx={{ position: 'absolute', display: 'flex', width: ['', '', '800px', '800px'], height: '300px', backgroundColor: clr.forest,  opacity: 0.7, zIndex: 10, borderRadius: '25px' }}/>
      <Box sx={{ position: 'absolute', display: 'flex', width: ['', '', '800px', '800px'], height: '300px', zIndex: 11 }}>
